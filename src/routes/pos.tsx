      ...
      <div className="p-12 px-28 overflow-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
          {filtered.map((p) => (
            ...
            >
              <div className="text-5xl mb-3 group-hover:scale-110 inline-block transition-transform">
                {p.image}
              </div>
              ...
              cart.map((item) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-1">
                    <button
                      onClick={() =>
                        actions.updateQty(item.variantId, item.qty - 1)
                      }
                      className="h-7 w-7 rounded-lg bg-background border border-border hover:bg-muted flex items-center justify-center"
                    >
                    ...
                    <button
                      onClick={() => actions.updateQty(item.variantId, 0)}
                      className="h-7 w-7 rounded-lg text-destructive hover:bg-destructive/10 flex items-center justify-center"
                    >
            ...
            <div className="border-t border-border p-5 space-y-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                <button
                  ...
                  className="flex flex-col items-center gap-1 py-3 rounded-xl bg-success text-success-foreground font-medium hover:opacity-90 transition"
                >
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-1 py-3 rounded-xl gradient-primary text-white font-medium hover:opacity-90 transition"
                >
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-1 py-3 rounded-xl bg-accent text-accent-foreground font-medium hover:opacity-90 transition"
                >
  ...
  return (
    ...
    >
      <div
        ...
        className="bg-card rounded-3xl p-6 w-full max-w-lg shadow-elegant"
      >
        ...
        <div className="grid grid-cols-2 gap-2 max-h-80 overflow-auto">
          {product.variants.map((v) => (
            ...
            >
              ...
              <div
                className={`text-xs font-bold mt-1 ${v.stock === 0 ? 'text-destructive' : v.stock <= 3 ? 'text-warning-foreground' : 'text-success'}`}
              >
